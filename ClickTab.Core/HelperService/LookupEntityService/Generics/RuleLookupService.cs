...
{
    public class RuleLookupService : LookupService
    {
        public RuleLookupService(DatabaseContext context) : base(context)
        {
        }

        public override List<IBaseEntity> GetEntitiesFromType(List<ComplexLinqPredicate> entityLinqPredicates)
        {
            return base.GetEntities<Rule>(entityLinqPredicates);
        }
    }
}
